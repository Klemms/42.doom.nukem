...
/*   Updated: 2019/05/07 22:50:13 by bsiche           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	render_hud(t_doom *d)
{
	...
	instant_text(d, d->surface, ft_itoa(d->you.hud.key),
			make_rect(125, 100, 30, 1));
	...
	instant_text(d, d->surface, ft_itoa(d->you.hud.health),
			make_rect(225, WIN_H - 95, 30, 1));
	r = make_rect(WIN_W - 450, WIN_H - 630, 600, 600);
	SDL_BlitScaled(d->you.hud.ammo_tt, NULL, d->surface, &r);
	instant_text(d, d->surface, ft_itoa(d->you.hud.ammo),
			make_rect(WIN_W - 250, WIN_H - 130, 40, 1));
}
